...
base.documentation.document_scenario(
    os.path.join(root_folder, "..", "..", "scenario", "nrw-1", "scenario.xproject"),
    os.path.join(root_folder, "..", "..", "scenario", "nrw-1", "README.md")
)
base.documentation.write_scenario_changelog(
    os.path.join(root_folder, "..", "..", "scenario", "nrw-1", "scenario.xproject"),
    os.path.join(root_folder, "..", "..", "scenario", "nrw-1", "CHANGELOG.md")
)
base.documentation.write_contribution_notes(
    os.path.join(root_folder, "..", "..", "scenario", "nrw-1", "CONTRIBUTING.md"))
